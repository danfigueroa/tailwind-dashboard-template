  ...
  return (
    <div className="col-span-full xl:col-span-8 bg-white shadow-lg rounded-sm border border-slate-200">
      <header className="px-5 py-4 border-b border-slate-100">
        <h2 className="font-semibold text-slate-800">Temas em saude - atividade fisica</h2>
      </header>
      <div className="p-3">
        ...
        <div className="overflow-x-auto">
          <table className="table-auto w-full">
            ...
            <thead className="text-xs uppercase text-slate-400 bg-slate-50 rounded-sm">
              <tr>
                <th className="p-2">
                  <div className="font-semibold text-left">Unidade de Saude</div>
                </th>
                <th className="p-2">
                  <div className="font-semibold text-center">Atendimentos Individuais</div>
                </th>
                <th className="p-2">
                  <div className="font-semibold text-center">Atendimentos Coletivos</div>
                </th>
                <th className="p-2">
                  <div className="font-semibold text-center">Desfecho</div>
                </th>
                <th className="p-2">
                  <div className="font-semibold text-center">Desfecho %</div>
                </th>
              ...
              <tr>
                <td className="p-2">
                  <div className="flex items-center">
                    ...
                    <div className="text-slate-800">Hospital 1</div>
                  </div>
                </td>
                <td className="p-2">
                  <div className="text-center">2.400</div>
                </td>
                <td className="p-2">
              ...
              <tr>
                <td className="p-2">
                  <div className="flex items-center">
                    ...
                    <div className="text-slate-800">Cais 1</div>
                  </div>
                </td>
                <td className="p-2">
                  <div className="text-center">2.223</div>
                </td>
                <td className="p-2">
              ...
              <tr>
                <td className="p-2">
                  <div className="flex items-center">
                    ...
                    <div className="text-slate-800">Cais 2</div>
                  </div>
                </td>
                <td className="p-2">
                  <div className="text-center">4.158</div>
                </td>
                <td className="p-2">
              ...
              <tr>
                <td className="p-2">
                  <div className="flex items-center">
                    ...
                    <div className="text-slate-800">Hospital 2</div>
                  </div>
                </td>
                <td className="p-2">
                  <div className="text-center">1.939</div>
                </td>
                <td className="p-2">
              ...
              <tr>
                <td className="p-2">
                  <div className="flex items-center">
                    ...
                    <div className="text-slate-800">Cais 3</div>
                  </div>
                </td>
                <td className="p-2">
                  <div className="text-center">720</div>
                </td>
                <td className="p-2">
